...
import { Brain, Send, ShieldCheck, CheckCircle2 } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-bold text-white flex items-center gap-2">
                  Aiforge v6.0 · Geometry Fix v0.2
                ...
                <div className="text-xs text-slate-400">
                  NVIDIA Brain → Review → Adapter → CORE v1.0 FREEZE
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-2">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Token se nikam trvale neukládá"
          ...
          {lastApplied && (
            <div className="border border-emerald-500/40 bg-emerald-950/30 text-emerald-300 rounded-lg px-3 py-2 text-xs flex items-center gap-2">
              ...
              Změny schváleny a Adapter vytvořil nový construction stav.
            </div>
          )}
        </div>
      </section>
